Pod::Spec.new do |s|
  s.name          = 'UniversalDetector-Mophie'
  s.version       = '1.3.3'
  ...
  s.homepage      = 'https://github.com/mophie/UniversalDetector'
  s.author        = { 'Francis Chong' => 'francis@ignition.hk' }
  s.source        = { :git => 'https://github.com/mophie/UniversalDetector.git', :tag => s.version.to_s }
